...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, KC_UP, _______, KC_PSCR,   KC_SCRL, KC_PSCR,    QK_BOOT,           PANE_H,
        _______, _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______,      _______,             _______,         PANE_V,
